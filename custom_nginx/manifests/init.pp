...
class custom_nginx (
  ...
  $reverse_proxy_domain            = $custom_nginx::params::reverse_proxy_domain,
  ...
  $reverse_proxy_resource          = $custom_nginx::params::reverse_proxy_resource,
  ...
  $forward_proxy_domain            = $custom_nginx::params::forward_proxy_domain,
